...
import { useNotificationLinks } from '@/lib/notifications';
...
// Sem sessão, só o login existe. Com sessão e sem primeiro acesso feito, o onboarding. Depois, o app inteiro.
// A splash some quando a sessão é conhecida.
function Routes() {
